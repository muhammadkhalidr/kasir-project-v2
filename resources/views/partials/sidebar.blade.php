        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('pembelian') }}" aria-expanded="false">
                            <i class="fa fa-book menu-icon"></i><span class="nav-text">Pembelian</span>
    ...
    @elseif (auth()->user()->level == 1)
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                ...
                <hr>
                <div class="text-center"><span>Versi {{ env('APP_VERSION') }}</span></div>
            </div>
        </div>
    @endif
@endif
