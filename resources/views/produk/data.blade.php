...
@section('content')
    ...
    {{-- Modal Tambah Data --}}
    <div class="modal fade static" id="tambahDataProduk" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="tambahDataProdukLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahDataProdukLabel">Tambah Produk</h5>
