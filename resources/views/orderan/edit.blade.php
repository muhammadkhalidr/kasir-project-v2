                ...
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title mb-4"> <i class="fa fa-arrow-left"
                                onclick="window.location='{{ url('orderan') }}'" style="cursor: pointer"></i> Edit Data
                            Orderan</h2>
                        <div class="form-validation">
                            <form class="form-valide" action="{{ url('orderan/' . $txtid) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        is-invalid
                                        @enderror"
                                            id="txtbarang" name="txtbarang" value="{{ $txtbarang }}">
                                        @error('txtbarang')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        is-invalid
                                        @enderror"
                                            id="txtharga" name="txtharga" value="{{ $txtharga }}">
                                        @error('txtharga')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        @enderror">
                                            ...
                                            <option value="L" {{ $txtket == 'L' ? 'selected' : '' }}>Lunas
                                            </option>
                                            <option value="BL" {{ $txtket == 'BL' ? 'selected' : '' }}>Belum Lunas
                                            </option>
                                        </select>
                                        @error('txtket')
                                            <div class="invalid-feedback">
